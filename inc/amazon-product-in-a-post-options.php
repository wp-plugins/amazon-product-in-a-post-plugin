...
//VARIABLES
	...
	$options_apipp= array (
					...
					array(	"name" => "Debug Key",
							"desc" => "Your Custom Debug Key. If you have problems with the plugin not working and you need help from the developer, email <a href='mailto:appip@fischercreativemedia.com'>appip@fischercreativemedia.com</a> with this key and your website url. They will be able to use it to figure out issues. Without it, they can do nothing to help. This is unique to your site. If you received help and the problem is resoved, you can change it to make sure the developer cannot access the debugging features, if you feel inclined to do so. <br /><br />",
